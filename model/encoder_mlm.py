...
def create_mask(x):
    ...
    Returns
    -------
    src_mask_encoder (tensor): masking tensor according to the input padding 
...
class Encoder(tf.keras.Model):
    ...
    Args:
        ...
        activation_func: feed-forward activation function
        ff_dim: feed-forward number of units
        pes: positional encoding tensor
    ...
    def __init__(self, vocab_size, model_size, num_layers, h, dropout, 
        ...
        self.dense_1 = [tf.keras.layers.Dense(
            ff_dim, activation=activation_fc) for _ in range(num_layers)]
    ...
    def call(self, sequence, training=True, encoder_mask=None):
        ...
        return x_out,ffn_out,alignments